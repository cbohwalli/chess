...
export default function getVerticalUpMoves(color, cell, gameState) {
    let allowedCells = [];

    for (let i = 1; i < 8; i++) {
        let verticalCell = getNewVerticalUpCell(cell, i);
...
function getNewVerticalUpCell(cell, iteration) {
