...
export default function getLowerRightDiagonalCells(color, cell, gameState) {
    let allowedCells = [];

    for (let i = 1; i <= 8; i++) {
        let newCell = getLowerRightDiagonal(cell, i);
...
function getLowerRightDiagonal(cell, iteration) {
