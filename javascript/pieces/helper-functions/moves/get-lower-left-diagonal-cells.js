...
export default function getLowerLeftDiagonalCells(color, cell, gameState) {
    let allowedCells = [];

    for (let i = 1; i <= 8; i++) {
        let newCell = getLowerLeftDiagonal(cell, i);
...
function getLowerLeftDiagonal(cell, iteration) {
